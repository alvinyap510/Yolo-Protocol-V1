...
// solhint-disable no-inline-assemblyå
import {BoringOwnable} from "@BoringSolidity/BoringOwnable.sol";
import {BoringFactory} from "@BoringSolidity/BoringFactory.sol";

/**
 * @dev     Based on MasterContractManager by BoringCrypto
 */
contract MasterContractManager is BoringOwnable, BoringFactory {
    ...
    function _calculateDomainSeparator(uint256 chainId) private view returns (bytes32) {
        return keccak256(abi.encode(DOMAIN_SEPARATOR_SIGNATURE_HASH, keccak256("YoloBox"), chainId, address(this)));
    }
